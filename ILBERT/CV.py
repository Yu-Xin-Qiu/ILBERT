...
if __name__ == "__main__":
    ...
    if config['task'] == 'Melting point':
        ...
        print('#--------------------------#')
        if config['DA'] == True:
            df = pd.read_csv("data/MP/expanded_MP.csv")
        ...
        print('#--------------------------#')
        if config['DA'] == True:
            df= pd.read_csv("data/C/expanded_C.csv")
            print("Using Data Augmentation!")
        else:
            df = pd.read_csv("data/C/Norm_C.csv")
            print("Not Using Data Augmentation!")
        ...
        print('#--------------------------#')
        if config['DA'] == True:
            df = pd.read_csv("data/EC/EC-DA.csv")
            print("Using Data Augmentation!")
        else:
        ...
        print('#--------------------------#')
        df = pd.read_csv("data/D/density_P.csv")
        print("Not Using Data Augmentation!")
        ...
        print('#--------------------------#')
        df = pd.read_csv("data/CO2/Norm_CO2.csv")
        print("Not Using Data Augmentation!")
